...
> **Absolute beginners:** Start with [`ELI5.md`](ELI5.md) — it is a friendly 15-minute install guide written for non-technical users.
...
`dtctl` is a CLI for Dynatrace resource management — required for demo workflows in this workspace.
